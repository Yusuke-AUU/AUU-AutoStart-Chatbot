...
function startChat() {
  ...
  chatBody.innerHTML = "";
  typeMessage("こんにちは！\n課題解決サポートチャットです 😊", () => {
    typeMessage("このチャットでは、あなたの「経営に関する悩み・気になること」を整理し、 専門家の紹介など、課題解決のサポートをします！", () => {
      typeMessage("✓相談＆専門家の紹介は完全無料です！\n✓チャットボット×AUUメンバーで最適な対応をします！\n✓話すだけで、課題のモヤモヤが整理できます！", () => {
        typeMessage("まずは以下から、気になる分野を選んでみてください 😊\n💡最近多いご相談：補助金・後継者・資金繰りなど💡", () => {
